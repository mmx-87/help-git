...
>для git характерны права доступа, используемые для ОС Linux. Но в файловой системе Windows права на файл используются совершенно другие.

Чтобы файлы был исполняемым в любой ОС, мы можем поставить исполнимый бит для файла напрямую в индекс GIT в обход файловой системы:
```
